...
import org.dawnsci.rap.application.editor.FooEditorInput;
import org.dawnsci.rap.application.wizard.SurveyWizard;
...
public class DawnActionBarAdvisor extends ActionBarAdvisor {
  ...
  public DawnActionBarAdvisor( final IActionBarConfigurer configurer ) {
    super( configurer );
  }

  protected void makeActions( final IWorkbenchWindow window ) {
    ImageDescriptor quitActionImage = AbstractUIPlugin.imageDescriptorFromPlugin( "org.dawnsci.rap.application",
                                                                                  "icons/ttt.gif" );
    ImageDescriptor helpActionImage = AbstractUIPlugin.imageDescriptorFromPlugin( "org.dawnsci.rap.application",
                                                                                  "icons/help.gif" );
    ImageDescriptor wizardActionImage = AbstractUIPlugin.imageDescriptorFromPlugin( "org.dawnsci.rap.application",
                                                                                    "icons/login.gif" );
    ImageDescriptor browserActionImage = AbstractUIPlugin.imageDescriptorFromPlugin( "org.dawnsci.rap.application",
                                                                                     "icons/internal_browser.gif" );
    ImageDescriptor rapWebSiteActionImage = AbstractUIPlugin.imageDescriptorFromPlugin( "org.dawnsci.rap.application",
                                                                                        "icons/browser.gif" );
    ...
    newEditorAction = new Action() {
      ...
      public void run() {
        try {
          window.getActivePage().openEditor( new FooEditorInput(DawnActionBarAdvisor.this),
                                             "org.dawnsci.rap.application.editor",
                                             true );
    ...
    newEditorAction.setId( "org.dawnsci.rap.application.neweditor" );
    ...
    aboutAction.setId( "org.dawnsci.rap.application.about" );
    ...
    rapWebSiteAction.setId( "org.dawnsci.rap.application.rapWebSite" );
    ...
    wizardAction.setId( "org.dawnsci.rap.application.wizard" );
    ...
    browserAction.setId( "org.dawnsci.rap.application.browser" );
